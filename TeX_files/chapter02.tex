...
\subsection{QCM calibrations}
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{Se-calibration.png} 
	\caption{Se calibration from 10/14/16. Effusion cell temperature was kept at 60C.}
	\label{fig:W calibration}
\end{figure}
\begin{figure}[H]
		\centering
		\includegraphics[width=1\textwidth]{W-calibration.png} 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{Sn-calibration.png} 
