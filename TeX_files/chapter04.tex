...
\begin{align*}   %* to not show equation number. & to tell which thing to align lines by
...
%R(\text{flux monitor pin to ground}) &= \infnty \Omega
\end{align*}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{W-evaporator-diagram.png} 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{W-evaporator-drawings.png} 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\textwidth]{Sn-evaporator-diagram.png} 
